...
<span class="token punctuation">}</span>
</code></pre></div><p>Default login request data.</p><blockquote><p>The <code>keyUser</code> option supports dot notation, allowing you to specify nested properties within the user object.</p></blockquote><h4 id="references-11" tabindex="-1">References <a class="header-anchor" href="#references-11" aria-hidden="true">#</a></h4><ul><li><a href="/guide/requests.html">Requests Guide</a></li><li><a href="/methods/register-and-login.html#login">login() Method</a></li><li><a href="/options/options-generate.html#redirect">redirect Option</a></li><li><a href="/options/options-generate.html#fetchuser">fetchUser Option</a></li><li><a href="/options/options-generate.html#staysignedin">staySignedIn Option</a></li></ul><h2 id="logoutdata" tabindex="-1">logoutData <a class="header-anchor" href="#logoutdata" aria-hidden="true">#</a></h2><div class="language-ts"><pre><code> @<span class="token keyword">typeof</span>  AxiosRequestConfig <span class="token operator">&amp;</span> <span class="token punctuation">{</span>
  redirect<span class="token operator">?</span><span class="token operator">:</span> RouteLocationRaw
    makeRequest<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">boolean</span>
  <span class="token punctuation">}</span>
 @<span class="token keyword">default</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre></div><p>Default fetch request data.</p><blockquote><p>The <code>keyUser</code> option now supports dot notation, allowing you to specify nested keys within the user object. For example, if your user object is structured as <code>{ profile: { details: { name: &#39;John&#39; } } }</code>, you can use <code>keyUser: &#39;profile.details.name&#39;</code> to access the name.</p></blockquote><h4 id="references-14" tabindex="-1">References <a class="header-anchor" href="#references-14" aria-hidden="true">#</a></h4><ul><li><a href="/guide/requests.html">Requests Guide</a></li><li><a href="/methods/user-data.html#fetch">fetch() Method</a></li><li><a href="/options/options-generate.html#enabled">enabled Option</a></li><li><a href="/options/options-generate.html#enabledInBackground">enabledInBackground Option</a></li></ul><h2 id="refreshtoken" tabindex="-1">refreshToken <a class="header-anchor" href="#refreshtoken" aria-hidden="true">#</a></h2><div class="language-ts"><pre><code>@<span class="token keyword">typeof</span> AxiosRequestConfig <span class="token operator">&amp;</span> <span class="token punctuation">{</span>
  enabled<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">boolean</span>
  enabledInBackground<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">boolean</span>
  interval<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">number</span> <span class="token operator">|</span> <span class="token boolean">false</span>
<span class="token punctuation">}</span>
