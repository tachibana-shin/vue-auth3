...
<span class="token punctuation">}</span><span class="token punctuation">,</span>
 ...
 @<span class="token keyword">default</span> <span class="token punctuation">{</span>
    ...
    makeRequest<span class="token operator">:</span> <span class="token boolean">false</span><span class="token punctuation">,</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre></div><p>Default unimpersonate request data.</p><h4 id="references-17" tabindex="-1">References <a class="header-anchor" href="#references-17" aria-hidden="true">#</a></h4><ul><li><a href="/guide/requests.html">Requests Guide</a></li><li><a href="/methods/impersonating.html#unimpersonate">unimpersonate() Method</a></li><li><a href="/options/options-generate.html#redirect">redirect Option</a></li><li><a href="/options/options-generate.html#fetchuser">fetchUser Option</a></li><li><a href="/options/options-generate.html#makerequest">makeRequest Option</a></li></ul>`,118),p=[o];function r(l,c,i,u,k,d){return s(),n("div",null,p)}var f=a(t,[["render",r]]);export{g as __pageData,f as default};
