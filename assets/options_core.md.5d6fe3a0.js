...
<span class="token punctuation">}</span>
</code></pre></div><p>Default login request data.</p><blockquote><p>The <code>keyUser</code> option supports dot notation, allowing you to specify nested properties within the user object. For example, if the response object is structured as <code>{ user: { details: { email: &#39;john@example.com&#39; } } }</code>, you can set <code>keyUser</code> to <code>user.details.email</code> to access the <code>email</code> property directly.</p></blockquote><h4 id="references-11" tabindex="-1">References <a class="header-anchor" href="#references-11" aria-hidden="true">#</a></h4><ul><li><a href="/guide/requests.html">Requests Guide</a></li><li><a href="/methods/register-and-login.html#login">login() Method</a></li><li><a href="/options/options-generate.html#redirect">redirect Option</a></li><li><a href="/options/options-generate.html#fetchuser">fetchUser Option</a></li><li><a href="/options/options-generate.html#staysignedin">staySignedIn Option</a></li></ul><h2 id="logoutdata" tabindex="-1">logoutData <a class="header-anchor" href="#logoutdata" aria-hidden="true">#</a></h2><div class="language-ts"><pre><code> @<span class="token keyword">typeof</span>  AxiosRequestConfig <span class="token operator">&amp;</span> <span class="token punctuation">{</span>
  redirect<span class="token operator">?</span><span class="token operator">:</span> RouteLocationRaw
    makeRequest<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">boolean</span>
  <span class="token punctuation">}</span>
 @<span class="token keyword">default</span> <span class="token punctuation">{</span>
...
@<span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  fetchUser<span class="token operator">:</span> <span class="token boolean">true</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre></div><p>Default oauth2 request data.</p><blockquote><p>After a token is received and the API request is made this will execute via the login method. All options available to the login method will also be available here.</p></blockquote><h4 id="references-13" tabindex="-1">References <a class="header-anchor" href="#references-13" aria-hidden="true">#</a></h4><ul><li><a href="/guide/oauth2.html">OAuth2 Guide</a></li><li><a href="/guide/requests.html">Requests Guide</a></li><li><a href="/methods/register-and-login.html#oauth2">oauth2() Method</a></li><li><a href="/options/options-generate.html#redirect">redirect Option</a></li><li><a href="/options/options-generate.html#fetchuser">fetchUser Option</a></li></ul><h2 id="fetchdata" tabindex="-1">fetchData <a class="header-anchor" href="#fetchdata" aria-hidden="true">#</a></h2><div class="language-ts"><pre><code>@<span class="token keyword">typeof</span>  AxiosRequestConfig <span class="token operator">&amp;</span> <span class="token punctuation">{</span>
  redirect<span class="token operator">?</span><span class="token operator">:</span> RouteLocationRaw
  keyUser<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">string</span>
  enabled<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">boolean</span>
  cache<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">boolean</span>
...
<span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre></div><p>Default fetch request data.</p><blockquote><p>The <code>keyUser</code> option supports dot notation, allowing you to specify nested properties within the user object. For example, if the response object is structured as <code>{ data: { user: { id: 123 } } }</code>, you can set <code>keyUser</code> to <code>data.user.id</code> to access the <code>id</code> property directly.</p></blockquote><h4 id="references-14" tabindex="-1">References <a class="header-anchor" href="#references-14" aria-hidden="true">#</a></h4><ul><li><a href="/guide/requests.html">Requests Guide</a></li><li><a href="/methods/user-data.html#fetch">fetch() Method</a></li><li><a href="/options/options-generate.html#enabled">enabled Option</a></li><li><a href="/options/options-generate.html#enabledInBackground">enabledInBackground Option</a></li></ul><h2 id="refreshtoken" tabindex="-1">refreshToken <a class="header-anchor" href="#refreshtoken" aria-hidden="true">#</a></h2><div class="language-ts"><pre><code>@<span class="token keyword">typeof</span> AxiosRequestConfig <span class="token operator">&amp;</span> <span class="token punctuation">{</span>
  enabled<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">boolean</span>
  enabledInBackground<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">boolean</span>
  interval<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">number</span> <span class="token operator">|</span> <span class="token boolean">false</span>
<span class="token punctuation">}</span>
...
@<span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  makeRequest<span class="token operator">:</span> <span class="token boolean">false</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre></div><p>Default unimpersonate request data.</p><h4 id="references-17" tabindex="-1">References <a class="header-anchor" href="#references-17" aria-hidden="true">#</a></h4><ul><li><a href="/guide/requests.html">Requests Guide</a></li><li><a href="/methods/impersonating.html#unimpersonate">unimpersonate() Method</a></li><li><a href="/options/options-generate.html#redirect">redirect Option</a></li><li><a href="/options/options-generate.html#fetchuser">fetchUser Option</a></li><li><a href="/options/options-generate.html#makerequest">makeRequest Option</a></li></ul>`,121),p=[o];function r(l,c,i,u,k,d){return s(),n("div",null,p)}var f=a(t,[["render",r]]);export{g as __pageData,f as default};
