import{_ as a,c as n,o as s,a as e}from"./app.27a8ca07.js";const g='{"title":"Overview","description":"","frontmatter":{},"headers":[{"level":2,"title":"rolesKey","slug":"roleskey"},{"level":2,"title":"rememberKey","slug":"rememberkey"},{"level":2,"title":"staySignedInKey","slug":"staysignedinkey"},{"level":2,"title":"tokenDefaultKey","slug":"tokendefaultkey"},{"level":2,"title":"tokenImpersonateKey","slug":"tokenimpersonatekey"},{"level":2,"title":"stores","slug":"stores"},{"level":2,"title":"cookie","slug":"cookie"},{"level":2,"title":"authRedirect","slug":"authredirect"},{"level":2,"title":"forbiddenRedirect","slug":"forbiddenredirect"},{"level":2,"title":"notFoundRedirect","slug":"notfoundredirect"},{"level":2,"title":"registerData","slug":"registerdata"},{"level":3,"title":"autoLogin","slug":"autologin"},{"level":3,"title":"staySignedIn","slug":"staysignedin"},{"level":2,"title":"loginData","slug":"logindata"},{"level":2,"title":"logoutData","slug":"logoutdata"},{"level":2,"title":"oauth2Data","slug":"oauth2data"},{"level":2,"title":"refreshToken","slug":"refreshtoken"},{"level":3,"title":"interval","slug":"interval"},{"level":2,"title":"impersonateData","slug":"impersonatedata"},{"level":2,"title":"unimpersonateData","slug":"unimpersonatedata"}],"relativePath":"options/core.md","lastUpdated":1682853378000}',t={},o=e(`<h1 id="overview" tabindex="-1">Overview <a class="header-anchor" href="#overview" aria-hidden="true">#</a></h1><div class="language-ts"><pre><code><span class="token keyword">type</span> <span class="token class-name">Options</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>The set of core options.</p><h2 id="roleskey" tabindex="-1">rolesKey <a class="header-anchor" href="#roleskey" aria-hidden="true">#</a></h2><div class="language-ts"><pre><code> @<span class="token keyword">typeof</span> <span class="token builtin">string</span>
 ...
 @<span class="token keyword">default</span> <span class="token punctuation">{</span>
    ...
    makeRequest<span class="token operator">:</span> <span class="token boolean">false</span><span class="token punctuation">,</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre></div><p>Default unimpersonate request data.</p><h4 id="references-17" tabindex="-1">References <a class="header-anchor" href="#references-17" aria-hidden="true">#</a></h4><ul><li><a href="/guide/requests.html">Requests Guide</a></li><li><a href="/methods/impersonating.html#unimpersonate">unimpersonate() Method</a></li><li><a href="/options/options-generate.html#redirect">redirect Option</a></li><li><a href="/options/options-generate.html#fetchuser">fetchUser Option</a></li><li><a href="/options/options-generate.html#makerequest">makeRequest Option</a></li></ul>`,114),p=[o];function r(l,c,i,u,k,d){return s(),n("div",null,p)}var f=a(t,[["render",r]]);export{g as __pageData,f as default};
